...
export default function Hero() {
  return (
    <section
      id="home"
      className="mx-auto scroll-mt-28 mt-24 grid w-[92%] overflow-hidden border border-[#2b241d] bg-[#11100e] text-white sm:w-[90%] lg:mt-28 lg:min-h-[760px] lg:grid-cols-[minmax(0,0.92fr)_minmax(360px,1fr)]"
    >
