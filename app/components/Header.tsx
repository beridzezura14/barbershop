...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 z-50 w-full border-b border-white/10 bg-[#11100e]/92 text-white backdrop-blur-md">
      <div className="mx-auto flex max-w-[90%] items-center justify-between py-4 pr-4">
        <h1 className="text-xl font-medium uppercase tracking-[0.2em] text-[#f3eadf]">
      ...
      <div
        ref={sidebarRef}
        className={`fixed inset-y-0 right-0 h-[100dvh] w-[340px] z-50 transition-transform duration-300 ${
      ...
      >
        <div className="flex h-full flex-col overflow-y-auto border-l border-white/10 bg-[#11100e] backdrop-blur-xl">
          ...
          <div className="p-6">
            ...
            <p className="mt-2 text-sm text-[#d4c4b2]/60">
              პრემიუმ შეჭრა დახვეწილი სტუდიის ატმოსფეროში.
            </p>
          </div>
          ...
          <div className="p-6">
            <p className="text-xs uppercase tracking-widest text-[#b89563]">გამოგვყევი</p>
